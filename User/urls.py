...
urlpatterns = [
    path("login/", views.MyLoginView.as_view(template_name='user/login.html'), name="login-page"),
    ...
    path('password-reset/',views.MyPasswordResetView.as_view(template_name="user/password_reset.html"),name='password-reset'),
    ...
    path('unsubscribe-newsletter/',views.unsubscribe_newsletter, name='unsubscribe-newsletter'),
